...
- **Time Markers**: Simplified labels at 12AM, 6AM, 12PM, 6PM for clarity, integrated as a table-like column.
...
- Start a new session, upload the JSON file, and verify the schedule is restored.
